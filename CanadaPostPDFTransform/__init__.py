...
from . import CanadaPostPDFTransforms as transform
import json
import os
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    if FileName:
       ...
       # Read raw data from blob in a BytesIO Object
            InvoiceRawData= helpfuncs.ReadPdfFromBlob(invoicefile= FileName)

       # Process Data 
            ProcessedData = transform.ExtractDataFromInvoice(file= InvoiceRawData ) 

            ProcessedData['CarrierShortName'] = 'CanadaPost'
       ...
       # Upload the Processed Data to blob and return blob name
            ...
            Text = json.dumps({"body": {'File':blob_data['blob_name'],\
                ...
                "Invoice": ProcessedData.loc[0,'InvoiceNumber'],\
                 "Message":  Text }})
